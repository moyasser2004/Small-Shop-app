...
import '../../screen/home_screen/const.dart';
...
class HomeScreenBody extends StatelessWidget {
  ...
  const HomeScreenBody({Key? key, required this.model}) : super(key: key);
      ...
      child: SizedBox(
        height: mg *
            (model.data.products.length -
                (model.data.products.length) / 1.23),
        child: Column(
          children: [
            Container(
              ...
              decoration: const BoxDecoration(
                border: Border(
                  bottom:
                  BorderSide(color: Color(0xFF605F5F), width: 2),
                  right:
                  BorderSide(color: Color(0xFF605F5F), width: 2),
                  left:
                  BorderSide(color: Color(0xFF605F5F), width: 2),
                      ...
                      return Container(
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            data[index].old_price - data[index].price! !=
                                0
                                ? Container(
